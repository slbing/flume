...
public class AvroFlumeEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroFlumeEvent\",\"fields\":[{\"name\":\"headers\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"body\",\"type\":\"bytes\"}]}");
  ...
  public static AvroFlumeEvent.Builder newBuilder() {
    return new AvroFlumeEvent.Builder();
  }
  ...
  public static AvroFlumeEvent.Builder newBuilder(AvroFlumeEvent.Builder other) {
    return new AvroFlumeEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroFlumeEvent>
    ...
    private Builder(AvroFlumeEvent.Builder other) {
      super(other);
    ...
    private Builder(AvroFlumeEvent other) {
            super(AvroFlumeEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.headers)) {
        this.headers = data().deepCopy(fields()[0].schema(), other.headers);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'headers' field */
    public AvroFlumeEvent.Builder setHeaders(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'body' field */
    public AvroFlumeEvent.Builder setBody(java.nio.ByteBuffer value) {
